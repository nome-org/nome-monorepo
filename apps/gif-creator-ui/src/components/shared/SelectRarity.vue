...
<template>
  <div class="grid md:grid-flow-row grid-cols-3 gap-x-4 gap-y-5 w-full">
    <button v-for="rarity in available_rarity" :key="rarity" @click="$emit('update:selectedRarity', rarity)"

      ...
      <main>
        ...
        <div class="w-full lg:w-[90%] xl:w-[80%] 2xl:w-[57%] text-base">
          <span class="block mb-6">
           BRC-20 is an experimental standard for fungible tokens on the Bitcoin blockchain. BRC-20 tokens unlock new capabilities for the Bitcoin network, such as their use in DeFi protocols and blockchain applications.
          </span>
          ...
          <span class="block mt-6">
            ...
            There are limited tokens available in a first-come, first-serve mint. However, a whitelist guarantees eligibility and offers a 20% discount.
          ...
          <span class="block mt-4">
            Read about utility and distribution in <a href="" target="_blank" rel="noreferrer noopener" class="font-bold text-[#A50EA5]">DOCS.</a>
          </span>
        </div>
        ...
        <div class="border-t border-solid border-opacity-20 border-white pt-2 md:mt-8 mt-12 w-full relative">
          ...
          <div class="flex items-center gap-6 mt-6 w-full md:w-[75%]">
            ...
            <input type="text" placeholder="Wallet address" v-model="address" class="border-white border-2 border-solid border-opacity-40 p-1.5 w-[70%] rounded-[10px] bg-transparent outline-none" />
          </div>
          <p class="mt-4 text-[#5A5A5A] text-sm">Sorry your wallet is not registered for Whitelist, public mint would be open soon</p>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-10 my-6">
            ...
            <div class="mx-auto w-[90%]">
              ...
              <div class="mt-8 flex flex-col">
                ...
                <input type="number" placeholder="min 1,000 / max 250,000" v-model="quantity" class="border-white border-2 border-solid border-opacity-40 p-1.5 w-full rounded-[10px] bg-transparent outline-none" />
              </div>
              ...
              <p class="text-center text-xl text-[#5a5a5a] mt-4">
                Link to the <a href="" target="_blank" rel="noreferrer noopener" class="underline underline-offset-8 hover:underline">mempool</a>
              </p>
            </div>
          </div>
        </div>
...
const selectedFee: string|null = ref(null); 
